    ...
    <div data-scroll data-scroll-section className="w-full py-20">
      ...
      <div className="px-20">
        <div className="cards flex gap-10 mt-10">
          ...
          >
            <h1 className="absolute flex overflow-hidden z-[9] text-8xl uppercase font-sans leading-none tracking-tighter right-0 translate-x-1/2 top-1/2 -translate-y-1/2 text-[#CDEA68]">
          ...
          <motion.div
            ...
            className="cardcontainer w-1/2 h-[75vh] relative"
          >
            <h1 className="absolute flex overflow-hidden z-[9] text-8xl uppercase font-sans leading-none tracking-tighter right-full translate-x-1/2 top-1/2 -translate-y-1/2 text-[#CDEA68] ">
