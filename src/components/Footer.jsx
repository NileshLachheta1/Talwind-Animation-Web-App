    ...
    <div className="w-full h-screen bg-zinc-900 p-20 flex gap-5">
      <div className="w-1/2 h-full flex flex-col justify-between font-sans">
        <div className="heading">
          <h1 className="text-[9vw] font-semibold leading-tighter uppercase leading-none -mb-5">
            Eye-
          </h1>
          <h1 className="text-[9vw] font-semibold leading-tighter uppercase leading-none -mb-5">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw] font-sans font-semibold leading-tighter uppercase leading-none -mb-5">
          Presentations
        </h1>
        <div className="dets py-20">
